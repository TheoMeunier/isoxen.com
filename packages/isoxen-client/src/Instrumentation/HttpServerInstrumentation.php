...
use Isoxen\Client\Instrumentation\Support\Http\HandlesHttpHeaders;
use Isoxen\Client\Instrumentation\Support\Http\HandlesHttpQueryString;
use Isoxen\Client\Instrumentation\Support\Http\Server\TraceRequestMiddleware;
